                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fef7f7; border-radius: 8px; margin-bottom: 20px;">
                        <tr>
                          <td style="padding: 20px;">
                            ...
                            ${order.expected_delivery_date ? `<p style="color: #6b7280; margin: 5px 0; font-size: 14px;"><strong>Expected Delivery Date:</strong> ${new Date(order.expected_delivery_date).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>` : ''}
