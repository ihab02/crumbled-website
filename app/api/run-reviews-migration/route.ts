...
export async function POST() {
  try {
    console.log('Starting customer reviews migration...');

    // Read the migration file
    const migrationPath = path.join(process.cwd(), 'migrations', 'add_customer_reviews.sql');
    ...
    console.log('Customer reviews migration completed successfully!');

    return NextResponse.json({
      success: true,
      message: 'Customer reviews migration completed successfully',
