...
-- Description: Adds an auto_close_seconds integer column to control automatic popup closing
-- Author: AI Assistant
-- Date: 2024-12-01
-- Version: 1.2
...
ADD COLUMN `auto_close_seconds` INT DEFAULT 0 
AFTER `show_button`;

-- Update existing records to have auto_close_seconds = 0 by default
